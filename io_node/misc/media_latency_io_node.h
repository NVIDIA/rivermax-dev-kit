...
#define RMAX_APPS_LIB_IO_NODE_MISC_MEDIA_LATENCY_IO_NODE_H_
...
public:
    ...
    /**
     * @brief: Overrides operator << for @ref ral::io_node::MediaTxIONode reference.
     */
...
public:
    ...
    /**
     * @brief: Overrides operator << for @ref ral::io_node::MediaRxIONode reference.
     */
    ...
    /**
     * @brief: Overrides operator << for @ref ral::io_node::MediaRxIONode pointer.
     */
...
protected:
    ...
    /**
     * @brief: Gets RTP parameters of the frame.
     *
...
#endif /* RMAX_APPS_LIB_IO_NODE_MISC_MEDIA_LATENCY_IO_NODE_H_ */
