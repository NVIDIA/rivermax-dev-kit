...
- **Module-specific examples**: Place in the corresponding module's directory (e.g., `apps/rmax_rtp_receiver/`, `services/memory_allocation/`). Use this for examples that demonstrate features, capabilities, or workflows of a single module, even if they use other modules as dependencies or supporting functionality.
