...
#include "rdk/examples/apps/rmax_xstream_media_sender/user_provided_settings_video_file_sender.h"

using namespace rivermax::dev_kit::apps::rmax_xstream_media_sender;
using namespace rivermax::dev_kit::services;
using namespace rivermax::dev_kit::examples::apps::rmax_xstream_media_sender;
...
{
    return UserProvidedSettingsVideoFileSenderExample().run(argc, argv);
}
