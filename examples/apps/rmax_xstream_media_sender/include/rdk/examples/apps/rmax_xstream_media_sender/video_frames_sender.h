...
#ifndef RDK_EXAMPLES_APPS_RMAX_XSTREAM_MEDIA_SENDER_VIDEO_FRAMES_SENDER_H_
#define RDK_EXAMPLES_APPS_RMAX_XSTREAM_MEDIA_SENDER_VIDEO_FRAMES_SENDER_H_
 ...
 * It uses a dummy frame provider that simulates frames from external application.
 */
...
#endif /* RDK_EXAMPLES_APPS_RMAX_XSTREAM_MEDIA_SENDER_VIDEO_FRAMES_SENDER_H_ */
