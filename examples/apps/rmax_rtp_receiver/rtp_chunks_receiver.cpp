...
#include "rdk/examples/apps/rmax_rtp_receiver/rtp_chunks_receiver.h"

using namespace rivermax::dev_kit::apps::rmax_rtp_receiver;
using namespace rivermax::dev_kit::services;
using namespace rivermax::dev_kit::examples::apps::rmax_rtp_receiver;
...
{
    return RTPChunksReceiverExample().run(argc, argv);
}
