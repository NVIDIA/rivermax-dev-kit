...
#ifndef RDK_APPS_RDK_IPO_RECEIVER_RDK_IPO_RECEIVER_H_
#define RDK_APPS_RDK_IPO_RECEIVER_RDK_IPO_RECEIVER_H_
 ...
 */
class IPOReceiverApp : public RDKReceiverBaseApp
{
private:
...
public:
    ...
    std::vector<IPORXStatistics> get_streams_total_statistics() const {
        return RDKReceiverBaseApp::get_streams_total_statistics<IPORXStatistics, AppIPOReceiveStream>();
    }
...
#endif /* RDK_APPS_RDK_IPO_RECEIVER_RDK_IPO_RECEIVER_H_ */
