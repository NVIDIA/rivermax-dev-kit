...
#ifndef RDK_APPS_RDK_RTP_RECEIVER_RDK_RTP_RECEIVER_H_
#define RDK_APPS_RDK_RTP_RECEIVER_RDK_RTP_RECEIVER_H_
 ...
 */
class RTPReceiverApp : public RDKReceiverBaseApp
{
private:
...
#endif /* RDK_APPS_RDK_RTP_RECEIVER_RDK_RTP_RECEIVER_H_ */
