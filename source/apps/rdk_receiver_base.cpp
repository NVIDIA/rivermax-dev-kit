...
#include "rdk/apps/rdk_receiver_base.h"
...
RDKReceiverBaseApp::RDKReceiverBaseApp() :
    RDKBaseApp()
{
}

ReturnStatus RDKReceiverBaseApp::initialize()
{
    ReturnStatus rc  = RDKBaseApp::initialize();
...
ReturnStatus RDKReceiverBaseApp::run()
{
...
void RDKReceiverBaseApp::distribute_work_for_threads()
{
...
ReturnStatus RDKReceiverBaseApp::initialize_memory_strategy()
{
    auto base_memory_strategy = std::make_unique<RDKBaseMemoryStrategy>(
...
ReturnStatus RDKReceiverBaseApp::set_receive_data_consumer(
