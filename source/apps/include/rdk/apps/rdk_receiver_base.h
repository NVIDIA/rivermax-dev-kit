...
#ifndef RDK_APPS_RDK_RECEIVER_BASE_H_
#define RDK_APPS_RDK_RECEIVER_BASE_H_
 ...
 */
class RDKReceiverBaseApp : public RDKBaseApp
{
protected:
...
public:
    virtual ~RDKReceiverBaseApp() = default;
...
protected:
     ...
     * in @ref RDKReceiverBaseApp::distribute_work_for_threads
     ...
     * std::thread objects will run in @ref RDKBaseApp::run_threads
     * method.
     */
...
template<typename StatisticsType, typename ReceiverStreamType>
std::vector<StatisticsType> RDKReceiverBaseApp::get_streams_total_statistics() const
{
...
#endif /* RDK_APPS_RDK_RECEIVER_BASE_H_ */
