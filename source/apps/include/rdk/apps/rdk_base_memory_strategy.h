...
#ifndef RDK_APPS_RDK_BASE_MEMORY_STRATEGY_H_
#define RDK_APPS_RDK_BASE_MEMORY_STRATEGY_H_
 ...
 */
class RDKBaseMemoryStrategy : public IMemoryStrategy
{
protected:
...
public:
     ...
     */
    RDKBaseMemoryStrategy(MemoryAllocator& header_allocator, MemoryAllocator& payload_allocator,
    ...
    /**
     * @brief: Destructor for RDKBaseMemoryStrategy.
     */
    virtual ~RDKBaseMemoryStrategy() = default;
...
#endif /* RDK_APPS_RDK_BASE_MEMORY_STRATEGY_H_ */
