...
#ifndef RDK_APPS_RDK_BASE_APP_H_
#define RDK_APPS_RDK_BASE_APP_H_
...
public:
     ...
     * The initialization flow, using @ref ::RDKBaseApp::initialize call, should be run
...
protected:
     ...
     * It will be called as part of the @ref ::RDKBaseApp::initialize process.
     *
     * @return: Status of the operation.
     */
...
template<typename T>
void RDKBaseApp::run_threads(T& io_nodes)
{
...
#endif /* RDK_APPS_RDK_BASE_APP_H_ */
