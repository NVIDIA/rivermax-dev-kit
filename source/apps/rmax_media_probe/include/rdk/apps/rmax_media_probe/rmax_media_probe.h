...
#ifndef RDK_APPS_RMAX_MEDIA_PROBE_RMAX_MEDIA_PROBE_H_
#define RDK_APPS_RMAX_MEDIA_PROBE_RMAX_MEDIA_PROBE_H_
...
/**
 * @brief: Configuration settings for Rivermax Media Probe.
 */
...
/**
 * @brief: Validator for Rivermax Media Probe settings.
 */
...
/**
 * @brief: CLI settings Builder for Rivermax Media Probe.
 */
 ...
 *
 * This is an example of application that uses Rivermax API to receive the
 ...
 */
class MediaProbeApp : public RmaxReceiverBaseApp
{
private:
...
#endif /* RDK_APPS_RMAX_MEDIA_PROBE_RMAX_MEDIA_PROBE_H_ */
