...
#include "rdk/apps/rdk_base_app.h"
#include "rdk/apps/rdk_base_memory_strategy.h"
...
RDKBaseMemoryStrategy::RDKBaseMemoryStrategy(
...
ReturnStatus RDKBaseMemoryStrategy::determine_memory_layout()
{
...
ReturnStatus RDKBaseMemoryStrategy::allocate_memory()
{
...
ReturnStatus RDKBaseMemoryStrategy::register_memory()
{
...
void RDKBaseMemoryStrategy::unregister_memory()
{
    if (!m_app_allocated_memory || !m_register_memory || !m_memory_registered) {
        return;
    }
...
ReturnStatus RDKBaseMemoryStrategy::apply_memory_layout()
{
...
ReturnStatus RDKBaseMemoryStrategy::apply_memory_layout_helper(
...
bool RDKBaseMemoryStrategy::allocate_aligned(
...
ReturnStatus RDKBaseMemoryStrategy::add_memory_subcomponent(std::shared_ptr<IHeaderPayloadMemoryLayoutComponent> component) {
