...
#ifndef RDK_APPS_RDK_MEDIA_PROBE_RDK_MEDIA_PROBE_H_
#define RDK_APPS_RDK_MEDIA_PROBE_RDK_MEDIA_PROBE_H_

#include <memory>

#include "rdk/apps/rdk_receiver_base.h"
#include "rdk/apps/rdk_media_probe/stream_monitor.h"
#include "rdk/apps/rdk_media_probe/media_monitor.h"
 ...
 */
class MediaProbeApp : public RDKReceiverBaseApp
{
private:
...
public:
    ...
    std::vector<RXStatistics> get_streams_total_statistics() const {
        return RDKReceiverBaseApp::get_streams_total_statistics<RXStatistics, AppRTPReceiveStream>();
    }
private:
    /**
...
#endif /* RDK_APPS_RDK_MEDIA_PROBE_RDK_MEDIA_PROBE_H_ */
