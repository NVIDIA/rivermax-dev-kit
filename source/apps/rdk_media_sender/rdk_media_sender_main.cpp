...
constexpr const char* APP_EXAMPLES = \
    "\nExamples:\n"
    "  1. rdk_media_sender --local-ip 1.2.3.4 --enable-video --video-resolution"
    " 1920x1080 --video-frame-rate 60 -v\n"
    "  2. rdk_media_sender --local-ip 1.2.3.4 --enable-video --video-resolution"
    " 1920x1080 --video-frame-rate 60 --dst-ip 234.5.6.7 --dst-port 2000\n"
    "  3. rdk_media_sender --local-ip 1.2.3.4 --enable-video --video-resolution"
