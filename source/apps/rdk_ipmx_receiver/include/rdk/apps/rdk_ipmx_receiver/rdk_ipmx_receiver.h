...
#ifndef RDK_APPS_RDK_IPMX_RECEIVER_RDK_IPMX_RECEIVER_H_
#define RDK_APPS_RDK_IPMX_RECEIVER_RDK_IPMX_RECEIVER_H_

#include <memory>

#include "rdk/apps/rdk_receiver_base.h"
#include "rdk/apps/rdk_ipmx_receiver/ipmx_stream_timeline_tracker.h"
 ...
 */
class IPMXReceiverApp : public RDKReceiverBaseApp
{
private:
...
#endif /* RDK_APPS_RDK_IPMX_RECEIVER_RDK_IPMX_RECEIVER_H_ */
