...
#ifndef RDK_APPS_RDK_IPMX_SENDER_RDK_IPMX_SENDER_H_
#define RDK_APPS_RDK_IPMX_SENDER_RDK_IPMX_SENDER_H_
 ...
 */
class IPMXSenderApp : public RDKBaseApp
{
private:
...
#endif /* RDK_APPS_RDK_IPMX_SENDER_RDK_IPMX_SENDER_H_ */
