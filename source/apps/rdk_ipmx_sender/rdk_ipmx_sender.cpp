...
#include "rdk/apps/rdk_ipmx_sender/rdk_ipmx_sender.h"
#include "rdk/services/sdp/sdp_common_descriptions.h"
#include "rdk/services/utils/clock.h"
#include "rdk/services/utils/defs.h"

using namespace rivermax::dev_kit::services;
using namespace rivermax::dev_kit::apps::rdk_ipmx_sender;
...
{
    ReturnStatus rc = RDKBaseApp::initialize_connection_parameters();
    if (rc != ReturnStatus::success) {
        return rc;
    }
