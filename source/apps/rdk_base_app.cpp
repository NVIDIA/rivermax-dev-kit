...
ReturnStatus RDKBaseApp::initialize_memory_allocators()
{
...
ReturnStatus RDKBaseApp::initialize_gpu_manager()
{
    if (m_app_settings->gpu_id == INVALID_GPU_ID) {
        return ReturnStatus::success;
    }
...
ReturnStatus RDKBaseApp::initialize()
{
...
ReturnStatus RDKBaseApp::initialize_rivermax_resources()
{
...
ReturnStatus RDKBaseApp::set_rivermax_clock()
{
    return ReturnStatus::success;
}

ReturnStatus RDKBaseApp::initialize_connection_parameters()
{
...
ReturnStatus RDKBaseApp::configure_memory_layout()
{
...
ReturnStatus RDKBaseApp::run_stats_reader()
{
...
ReturnStatus RDKBaseApp::cleanup_rivermax_resources()
{
    if (m_memory_strategy) {
...
ReturnStatus RDKBaseApp::find_internal_stream_index(
...
ReturnStatus RDKBaseApp::get_app_settings(const AppSettings*& settings) const {
