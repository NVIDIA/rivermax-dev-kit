...
#ifndef RDK_SERVICES_BUFFER_WR_RTP_ANCILLARY_BUFFER_WRITER_H_
#define RDK_SERVICES_BUFFER_WR_RTP_ANCILLARY_BUFFER_WRITER_H_
 ...
 */
class RTPAncillaryBufferWriter : public RTPMediaBufferWriter
{
public:
