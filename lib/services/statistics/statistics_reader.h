...
#ifndef RMAX_APPS_LIB_LIB_SERVICES_STATISTICS_STATISTICS_READER_H_
...
protected:
    ...
    /* Statistics generating procedd ID, default 0 is local process */
...
public:
     ...
     *
     * @return: Status of the operation as defined by @ref ral::lib::services::ReturnStatus.
     */
...
protected:
     ...
     *          @ref ral::lib::services::ReturnStatus::success - There might be additional messages to be read.
     *          @ref ral::lib::services::ReturnStatus::no_free_chunks - No additional messages to be read.
...
#endif /* RMAX_APPS_LIB_LIB_SERVICES_STATISTICS_STATISTICS_READER_H_ */
